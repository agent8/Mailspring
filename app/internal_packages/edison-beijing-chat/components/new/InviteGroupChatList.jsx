...
export default class InviteGroupChatList extends Component {
  ...
  _setDropDownHeight() {
    ...
    if (dropDown) {
      ...
      const maxHeight = nodeRect.height + nodeRect.top - offsetTop;
      dropDown.style.maxHeight = `${maxHeight - 5}px`;
    }
  }
      ...
      <div className="contactsList">
        ...
        <div>
          <Select
            ...
            mode="tags"
            style={{ width: '100%' }}
            dropdownStyle={{ top: 156, height: 400 }}
            className="contactsListSelect"
