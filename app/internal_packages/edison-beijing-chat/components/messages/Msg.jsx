...
export default class Msg extends PureComponent {
  ...
  constructor(props) {
    ...
    this.receiveProps = this.receiveProps.bind(this);
    this.shouldDisplayFileIcon = this.shouldDisplayFileIcon.bind(this);
    ...
    this.senderName = this.senderName.bind(this);
  ...
  renderMessageToolbar(msg, msgBody, isFile, isCurrentUser) {
        ...
        >
          ...
          <div className="message-content">
            ...
            <div className="messageBody">
              {this.renderContent()}
              {this.renderMessageToolbar(msg, msgBody, !!msgBody.mediaObjectId, isCurrentUser)}
            </div>
          </div>
          {messageFail ? (
