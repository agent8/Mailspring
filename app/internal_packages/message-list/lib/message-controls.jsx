...
export default class MessageControls extends React.Component {
  ...
  _items () {
    ...
    const ret = defaultReplyType === 'reply-all' ? [replyAll, reply, forward] : [reply, replyAll, forward]
  ...
  _dropdownMenu (items) {
    ...
    return <Menu items={items} itemKey={item => item.name} itemContent={itemContent} onSelect={item => item.select()} />
  }
            ...
            <div className='remove-tracker-popover'>
              ...
              >
                <div className='remove-tracker-notice'>
                  ...
                  />
                  <p>
                    <b>Email tracking is Blocked</b> Senders won't see when and where you read messages.
                  </p>
                </div>
              </FixedPopover>
            </div>
