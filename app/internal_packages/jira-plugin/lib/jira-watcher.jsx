...
export default class Watcher extends Component {
  ...
  _renderProgress = () => {
    ...
    if (progress === 'loading') {
      return <div className="loading">{this._renderLoading(20)}</div>;
    }
    return null;
  };
    ...
    return (
      <div className="jira-watchlist">
          ...
          >
            {watchers &&
              watchers
                ...
                .map(item => (
                  <div className="row" key={item.accountId}>
                    ...
                    <span
                      ...
                      onClick={() => this.removeWatcher(item.accountId)}
                    >
                      <RetinaImg name="close.svg" isIcon mode={RetinaImg.Mode.ContentIsMask} />
                    </span>
                  </div>
                ))}
          </CSSTransitionGroup>
        ...
        <div className="add-watcher">
          {!adding ? (
            <div className="row" onClick={this._handleClickAddWatcher}>
              + Add watchers
            </div>
          ) : (
            <Select
