...
export default class Pad extends Component {
  ...
  render () {
    ...
    const unReadBadge = unreadMessageStr ? (
      <span className='pad-badge' onClick={this.enterChatRoom}>
        {unreadMessageStr}
      </span>
    ) : null
    from = (from && from.join(', ')) || ''
    ...
    return (
      <div className='team-edit-pad' key={pad.id}>
        <div>
          <span className='pad-head' onClick={this.OpenEditPad}>
            &#x25AA;
          </span>
