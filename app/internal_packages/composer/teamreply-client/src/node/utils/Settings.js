...
// exports.consulSetting = {
//   server: { host: "localhost", port: 8500 },
//   client: { port: 9001, http: "/api/1/health", interval: "30s", timeout: "5s" }
// };
/**
...
exports.reloadSettings = function reloadSettings(settings) {
  // Discover where the settings file lives
  var settingsFilename = absolutePaths.makeAbsolute(argv.settings || settings || "settings.json");
...
exports.reloadSettings("settings.json");
