...
export const AWSAccessKey = process.env.S3_ACCESSKEY_ID || 'AKIAJPPBMFBNHSNZ5ELA';
export const AWSSecretKey = process.env.S3_SECRET_ACCESSKEY || 'ExXA8D6xk4261V03ZkVIu0hc';
