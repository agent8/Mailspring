...
class OutlineViewItem extends Component {
  ...
  constructor(props) {
    ...
    this._targetDivRef = null;
    this._setTargetDivRef = el => (this._targetDivRef = el);
    this._mounted = false;
  }
  ...
  render() {
    ...
    return (
      <div className={item.className ? item.className : null} ref={this._setSelfRef}>
        <span className={containerClasses} ref={this._setTargetDivRef}>
          {this._renderItem()}
          <DisclosureTriangle
