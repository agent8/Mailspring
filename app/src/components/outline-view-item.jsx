...
class OutlineViewItem extends Component {
  ...
  constructor(props) {
    ...
    this._selfRef = React.createRef();
    this._targetDivRef = React.createRef();
    this._mounted = false;
  }
  ...
  componentDidMount() {
    ...
    if (this._selfRef.current) {
      this._selfRef.current.addEventListener('contextmenu', this._onShowContextMenu);
    }
    this.setState({
      targetDiv: this._targetDivRef.current,
    });
  ...
  componentWillUnmount() {
    ...
    if (this._selfRef.current) {
      this._selfRef.current.removeEventListener('contextmenu', this._onShowContextMenu);
    }
  }
  ...
  render() {
    ...
    if (item.id && item.id === MORE_TOGGLE) {
      ...
      return (
        <div onClick={this._onToggleShowAllFolder} ref={this._selfRef}>
    ...
    return (
      <div className={item.className ? item.className : null} ref={this._selfRef}>
        <span className={containerClasses} ref={this._targetDivRef}>
          {this._renderItem()}
          <DisclosureTriangle
