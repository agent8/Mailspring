      ...
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn(
            this,
            (_ref = Void.__proto__ || Object.getPrototypeOf(Void)).call.apply(
              _ref,
              [this].concat(args)
            )
          )),
  ...
  _createClass(Void, [
    {
      ...
      value: function render() {
        ...
        var draggerDisable = node.data.get ? node.data.get('draggerDisable') : false;
        ...
        var content = _react2.default.createElement(
          Tag,
          { draggable: readOnly || draggerDisable ? null : true },
          children
        );
