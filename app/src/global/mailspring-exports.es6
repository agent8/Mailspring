...
lazyLoadAndRegisterTask('MuteNotifacationsTask', 'mute-notifacations-task');
lazyLoadAndRegisterTask('UnMuteNotifacationsTask', 'unmute-notifacations-task');
lazyLoadAndRegisterTask('GetMuteListTask', 'sync-mute-list-task');
...
lazyLoad('MuteNotifacationsStore', 'flux/stores/mute-notifacations-store');
